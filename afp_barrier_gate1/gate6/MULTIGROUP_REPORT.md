...
The functional layer lowers transmitted energy relative to the buffer-control
stack and increases the fraction of deposition in the functional region from
about 7.9% to about 24.6%.
...
energy-deposition identity. The deterministic benchmark separately verifies
the complete space--angle implementation and the synthetic multilayer response.
