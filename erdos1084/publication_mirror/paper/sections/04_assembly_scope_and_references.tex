...
\item the Bezdek--L\'angi truncated-density definition and identity
$\delta(\lambda)=\delta_3$ for $\lambda\ge1$;
...
\end{enumerate}
The finite specialization of (ii) is explicit: for a finite packing the numerator
and denominator in the defining quotient stabilize for large truncation radius.
...
explicit published-input structures.  It does not claim foundational Lean
reconstructions of (i)--(v); ordinary theorem parameters remain visible in the
