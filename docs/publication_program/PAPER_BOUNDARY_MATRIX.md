...
|---|---|---|---|---|---|---|
| sampled quadratic quotient and covariance factorization | foundation | fixed definition | shared constraint | sampling-kernel correctness | nonzero algebraic form is not necessarily sampled nonzero | I |
