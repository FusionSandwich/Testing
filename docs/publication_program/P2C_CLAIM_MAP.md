...
| C08 | a protected co-design minimizer exists | Theorem 3 | protected data structures/audits | compact-margin tests; analytic theorem, not finite proof |
...
| C17 | finite graph-orbit search terminates at declared neighborhood stationarity | Section 8 | GraphSearchLedger | no-revisit and certified-gap tests |
...
| C20 | P1B/P1E inner-optimal family has all-level quadratic order | Theorem 8 | convergence.py | symbolic constant product and finite benchmark |
