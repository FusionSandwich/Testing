...
| structured latitude perturbation | robustness | OPEN_UNCERTIFIED | determinant and scaling diagnostics for a fixed-support reflected perturbation route | literal straight-line program, operation count, denominator guards and recurrence certificate are missing | commit and independently verify the complete certificate | I/III |
